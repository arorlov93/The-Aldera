...
Every product has two columns.

- **Target** is what we want and what we will pay a premium for.
- **Minimum acceptable** is the floor. Below it we do not buy.

Quote the target. If you cannot reach it, quote the minimum and say plainly which line you could not
meet and why. A quotation that silently drops below the minimum is treated as no quotation at all.
...
## PART A — REQUIREMENTS THAT APPLY TO EVERY PRODUCT

### A1. Dosing philosophy

Doses below are floors, not targets to be reduced. Our brand is built on printing the full dose and
...
| Line | Target | Minimum acceptable |
|---|---|---|
| Irish sea moss, Chondrus crispus | **1,500 mg** | **1,000 mg** |
| Bladderwrack, Fucus vesiculosus | **500 mg** | **300 mg** |
| Burdock root, Arctium lappa | **150 mg** | **100 mg** |
| Iodine per serving | Measured and declared | **Pass or fail: never above 225 mcg** |
...
| Line | Target | Minimum acceptable |
|---|---|---|
| Lion's mane extract 10:1, Hericium erinaceus | **750 mg** | **500 mg** |
| Plant part | Fruiting body only | Pass or fail |
| Beta glucans | **30% minimum**, enzymatic assay | **20%**, enzymatic assay |
| Not acceptable | Mycelium on grain, starch carriers, flour dilution | |
